...
@Setter
@Entity
@Table(name="job_list_ubcf")
public class JobListUbcf extends JobInfo implements Serializable {
...
//	private String isPc;
	...
	public String toString() {
		return String.format("JobListUbcf(advId=%s, isPc=%s, size=%s)", key.getAdvId(), this.isPc(), this.size);
	}	
}
