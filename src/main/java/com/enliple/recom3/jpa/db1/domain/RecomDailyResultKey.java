...
@Data
@Embeddable
public class RecomDailyResultKey implements Serializable {
    ...
    public RecomDailyResultKey() {

    }
    @Builder
    public RecomDailyResultKey(String advId,int datetime,String ispc,String recomType) {
