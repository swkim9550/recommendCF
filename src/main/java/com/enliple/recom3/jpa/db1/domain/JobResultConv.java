...
import com.enliple.recom3.jpa.db1.domain.JobResult.JobResultBuilder;
...
@ToString
@Entity
@Table(name="job_result_conv")
public class JobResultConv implements Serializable {
	@Builder
	public JobResultConv(JobResultKey key, long pcodeCount, long auidCount, LocalDateTime createTime) {
		this.key = key;
