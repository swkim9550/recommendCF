...
@ToString
@Entity
@Table(name="job_result_ubcf")
public class JobResultUbcf implements Serializable {
	@Builder
	public JobResultUbcf(JobResultKey key, long pcodeCount, long auidCount, LocalDateTime createTime) {
		this.key = key;
